...
(async () => {
    ...
    const filePath = path.resolve(__dirname, 'ad2.html');
    ...
    console.log('Exported ad2.png (1080x1080)');

    // Export vertical version (1080x1920) for Stories/Reels
    await page.setViewport({ width: 1080, height: 1920, deviceScaleFactor: 1 });

    const verticalPath = path.resolve(__dirname, 'ad2-vertical.html');
    ...
    await page.screenshot({
        path: path.resolve(__dirname, 'ad2-vertical.png'),
        type: 'png',
        clip: { x: 0, y: 0, width: 1080, height: 1920 },
    });

    console.log('Exported ad2-vertical.png (1080x1920)');
    ...
    const landscapePath = path.resolve(__dirname, 'ad2-landscape.html');
    ...
    await page.screenshot({
        path: path.resolve(__dirname, 'ad2-landscape.png'),
        type: 'png',
        clip: { x: 0, y: 0, width: 1200, height: 628 },
    });

    console.log('Exported ad2-landscape.png (1200x628)');
    await browser.close();
})();
